...
const uiText = {
    uk: {
        ...
        slots_title: "Слоти",
        back: "Назад",
        ball_hint: "Натисни на кулю",
        tap_roll: "Натисни, щоб кинути",
    ...
    ru: {
        ball_title: "Шар Судьбы",
        d6_title: "Кубик D6",
        d20_title: "Кубик D20",
        rand_title: "Рандомайзер",
        coin_title: "Монетка",
        slots_title: "Слоты",
        back: "Назад",
        ball_hint: "Нажми на шар",
        tap_roll: "Нажми, чтобы бросить",
        rand_limit_label: "Максимум:",
        generate: "Старт",
        spin_btn: "КРУТИТЬ",
        heads: "ОРЕЛ",
...
function setLang(lang) {
    ...
    // coin text (надежнее, чем ::after при 3D)
...
window.rollD20 = function() {
    ...
    // 2) честный результат 1..20
    const roll = Math.floor(Math.random() * 20) + 1;

    // 3) доворот в “стабильную” позу под результат + показать оверлей
    setTimeout(() => {
